...
@EqualsAndHashCode
@ToString
public class ChangePasswordTransaction implements Serializable {
    ...
    ChangePasswordTransaction(AccountId accountId, AccountRevision accountRevision) {
        this(new AccountTransactionId(), accountId, accountRevision);
    }

    ChangePasswordTransaction(AccountTransactionId transactionId, AccountId accountId, AccountRevision accountRevision) {
